      ...
      <Layout title="Assignments">
        <main className="flex-1 flex bg-gray-200">
          ...
          <section className="hidden md:flex md:flex-col md:justify-center md:items-center w-full">
            ...
            <p className="max-w-lg text-gray-400 text-justify mt-2">
              Please select an assignment from the list on the left to get started with viewing your submission grading
              report or submit your work.
            </p>
          </section>
        </main>
      </Layout>
