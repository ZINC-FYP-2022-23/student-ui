      ...
      <a className={`px-6 py-3 block ${assignmentId === id ? "bg-blue-100 border-l-4 border-cse-300" : "bg-white"}`}>
        <div className="flex justify-between">
          ...
          <span className="text-sm text-gray-600">
            {new Date(showAt ?? createdAt).toLocaleDateString("en-US", {
              year: "numeric",
              month: "short",
              day: "numeric",
            })}
        ...
        <p className="text-sm text-gray-500">
          During this time of Covid-19 pandemic, many people including nurses, doctors, engineers, and scientists, all
          want to...
        </p>
      </a>
    </Link>
