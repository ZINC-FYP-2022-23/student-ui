  ...
  return (
    <div className="bg-white shadow rounded-lg border">
      <header className="bg-gray-100 w-full px-4 py-3 rounded-tl-lg rounded-tr-lg border-b flex justify-between items-center">
        ...
        <span className="bg-teal-400 w-10 h-10 rounded-full flex justify-center items-center shadow">
      ...
      <div className="px-4 py-3 flex flex-col justify-between">
        <div>
          <nav className="flex items-center">
            <button
              ...
              className={`px-3 py-1 font-medium text-xs tracking-wider uppercase leading-5 rounded-md ${
                logView === "stdout"
            ...
            <button
              ...
              className={`ml-4 px-3 py-1 flex items-center font-medium text-xs tracking-wider uppercase leading-5 rounded-md ${
                logView === "stderr"
                  ? "text-gray-700 bg-gray-100"
                  : "text-gray-600 hover:text-gray-800 focus:text-gray-800"
              } focus:outline-none  focus:bg-gray-200`}
        ...
        <div className="my-4 rounded-md bg-gray-700 border p-3 text-white font-mono h-32 overflow-y-auto">
          {reports[viewingIndex][logView].length > 0 &&
            reports[viewingIndex][logView].map((line, i) => <p key={i}>{line}</p>)}
